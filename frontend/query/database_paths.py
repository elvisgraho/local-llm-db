...
if _env_db_path:
    ...
    # Fallback to the local project structure: ../training/databases
    # Resolves to: <project_root>/training/databases
    DATABASE_DIR = Path(__file__).resolve().parent.parent / "training" / "databases"
